...
@section('content')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ url('') }}/transactions/orders/laundry/create" class="btn btn-primary">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="tb-laundry" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>No. Transaksi</th>
    ...
    @push('myscript')
        ...
        <script src="{{ asset('assets/js/Pages/Service/Laundry/app.js') }}?{{ rand() }}"></script>
    @endpush
@endsection
