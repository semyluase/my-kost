        ...
        <div class="row">
            <div class="col-12">
                <div class="table-responsive">
                    <table class="table table-vcard-center card-table table-striped" id="tb-rules" style="width:100%">
                        <thead>
...
@push('myscript')
    ...
    <script src="{{ asset('assets/js/Pages/Master/Rules/app.js') }}?{{ rand() }}"></script>
@endpush
