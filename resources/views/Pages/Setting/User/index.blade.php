...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="tb-user" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Name</th>
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input type="hidden" name="id-user" id="id-user" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
    ...
    @push('myscript')
        ...
        <script src="{{ asset('assets/js/Pages/Setting/User/app.js') }}?{{ rand() }}"></script>
    @endpush
@endsection
